...
/// ジョイスティック
/// </summary>
public class Joystick1 : Graphic, IPointerDownHandler, IPointerUpHandler, IEndDragHandler, IDragHandler {
//実際に動くスティック部分
...
private float _radius = 15;
    ...
    public bool _shouldResetPosition = true;
    public bool p_shouldResetPosition = true;
...
Vector2 screenPos = Vector2.zero;
        ...
        foreach (Touch t in Input.touches)
        {
            ...
            {
                RectTransformUtility.ScreenPointToLocalPointInRectangle(GetComponent<RectTransform>(),
                               new Vector2(Input.touches[1].position.x, Input.touches[1].position.y),
               null,
               out screenPos
                   );
                Debug.Log("touch1");
